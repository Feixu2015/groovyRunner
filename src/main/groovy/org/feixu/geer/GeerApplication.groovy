...
class GeerApplication implements CommandLineRunner, ExitCodeGenerator {
    ...
    static final String SPECIAL = '65f0dd45-60cf-45c6-a1f6-327fb547659f'

    private static boolean is4Test(String[] args) {
        null != args && args.size() > 0 && args[0].equals(SPECIAL)
    }

    static void main(String[] args) {
        if (is4Test(args)) {
            SpringApplication.run(GeerApplication, args)
        } else {
